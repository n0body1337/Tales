...
///
/// Uses the standard 781-entry PG table, NOT the engine's internal Zobrist hash.
/// This key is used to look up book entries via binary search.
#[inline]
...
#[inline]
pub fn polyglot_move_to_string(raw: u16, pos: &Position) -> String {
...
///
/// `book_filter` is a 0–100 percentage threshold: moves whose weight is below
/// `(max_weight * book_filter / 100)` are excluded. 0 = use all moves,
/// 100 = only the best move.
#[inline]
pub fn is_infrequent(val: i32, max_weight: i32, book_filter: i32) -> bool {
